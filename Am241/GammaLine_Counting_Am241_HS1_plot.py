...
def main():
    ...
    try:
        ...
        p.figure(dir+"/PeakCounts/"+detector+"/"+source+"/new/plots/sim/"+detector+"_103keV_myplot.png")
    ...
    for index, i in enumerate(peak_ranges):
        ...
        try:
            ...
            p1.figure(dir+"/PeakCounts/"+detector+"/"+source+"/new/plots/sim/"+detector+"_59keV_cuts_myplot.png")
