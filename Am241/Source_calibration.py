...
def variance(ratio,err, thresh=1e-6, iter_max=200):
...
def main():
    ...
    with open(ParametersCal) as json_file:
        ...
        for detector in detectors_list:
            ...
            ratio_new = a_am6 /ratio#*np.exp(0.7745-0.7415)
            ratio_new_err = StatisticalError(a_am6, ratio, a_am6_err, ratio_err)*ratio_new
    ...
    mean_ratio_err=v=np.sqrt(stat.variance(ratio_new_list))
