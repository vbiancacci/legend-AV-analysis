        ...
        for detector in detectors:
            ...
            if Calibrate_Data == True:
                ...
                if order == 2:
                    ...
                    data_path="/lfs/l1/legend/legend-prodenv/prod-usr/ggmarsh-test-v03/gen/"+detector+"/tier2/th_HS2_"+pos+"_psa/"
            ...
            if Gamma_line_count_data == True:
                ...
                os.system("python "+CodePath+"/GammaLine_Counting_Th.py --data "+detector+" "+data_path+" "+calibration+" "+energy_filter+" "+cuts+" "+str(run))
            ...
            if Gamma_line_count_MC == True:
                ...
                for FCCD in FCCD_list:
                    ...
                    for DLF in DLF_list:
                        MC_id=detector+"-th_HS2-top-0r-38z_"+smear+"_"+TL_model+"_FCCD"+str(FCCD)+"mm_DLF"+str(DLF)+"_fracFCCDbore"+str(frac_FCCDbore)
                        sim_path="/lfs/l1/legend/detector_char/enr/hades/simulations/legend-g4simple-simulation/simulations/"+detector+"/"+source+"/top_0r_38z/hdf5/AV_processed/"+MC_id+".hdf5"
                        os.system("python "+CodePath+"/GammaLine_Counting_Th.py --sim "+detector+" "+sim_path+" "+MC_id + " save")
            ...
            if PlotSpectra == True:
                ...
                MC_id=detector+"-th_HS2-top-0r-45z"+"_"+smear+"_"+TL_model+"_FCCD"+str(FCCD)+"mm_DLF"+str(DLF)+"_fracFCCDbore"+str(frac_FCCDbore)
                sim_path="/lfs/l1/legend/detector_char/enr/hades/simulations/legend-g4simple-simulation/simulations/"+detector+"/th_top_0r_32z/hdf5/AV_processed/"+MC_id+".hdf5"

                #os.system("python "+CodePath+"/PlotSpectra.py "+detector+" "+MC_id+" "+sim_path+" "+data_path+" "+calibration+" "+energy_filter+" "+cuts+" "+str(run))
